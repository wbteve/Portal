...
<div class="profile"<?php print $attributes; ?>>
  <?php 
  if(!empty($user_profile['field_fullname']['#items'][0]['value'])){
    print render($user_profile);
  }else{
    print t('You don\'t have any profile information yet. Please edit your profile and fill in the missing information.');
  }
  ?>
</div>
